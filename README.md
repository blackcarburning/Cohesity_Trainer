...
- Steering guidance is applied only when it stays compatible with Cohesity Architect Expert scope, JSON/schema/output-count requirements, distractor and multi-select rules, the ~10% implementation-detail requirement, official-doc citation preference, and prompt-injection/safety constraints.
