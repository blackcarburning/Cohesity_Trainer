...
- Supports both single-answer and multi-select questions (for example, “Select 2 answers”) with strict set-match scoring for multi-select.
...
- OpenAI-generated batches can include a mix of single-answer and multi-select scenario questions using either `correctAnswerIndex` or `correctAnswerIndexes`.
